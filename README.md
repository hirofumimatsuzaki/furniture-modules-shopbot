...
- `椅子` タブ
  - `SOKUMEN / UE / SEMOTARE / MAE / USHIRO / ASHI` の部品セットを生成
  - 座面幅・側面幅・脚長・背もたれ長さ・背もたれ角度を調整可能
  - いただいた椅子スケッチロジックを部品出力向けに統合
- `机` タブ
  - `TENBAN / MAKUITA1 / MAKUITA2 / ASHI1 / ASHI2 / ASHISAKI` の部品セットを生成
  - 横幅・縦幅・脚長・幕板・脚左右オフセットを調整可能
  - いただいた机スクリプトの形状ロジックを部品出力向けに統合
- 共通
  - mm単位パラメトリック調整
  - 板厚 / クリアランス / エンドミル径を反映
